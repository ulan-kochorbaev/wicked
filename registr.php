...
<head>
    ...
    <title>Регистрация - Wicked</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <form action="save_user.php" method="POST">
            <input type="text" name="name" placeholder="Имя пользователя" required class="input-field">
            <input type="text" name="login" placeholder="login" required class="input-field">
        ...
        <p>Уже есть аккаунт? <a href="avtor.php" class="link">Авторизация</a></p>
    </div>
</body>
</html>